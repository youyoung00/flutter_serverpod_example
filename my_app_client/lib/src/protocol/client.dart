...
class _EndpointPixoramaendpoint extends EndpointRef {
  @override
  String get name => 'pixoramaendpoint';

  _EndpointPixoramaendpoint(EndpointCaller caller) : super(caller);
}
...
class Client extends ServerpodClient {
  ...
  late final _EndpointPixoramaendpoint pixoramaendpoint;
  ...
  Client(String host,
    ...
    pixoramaendpoint = _EndpointPixoramaendpoint(this);
  ...
  Map<String, EndpointRef> get endpointRefLookup => {
        'example': example,
        'pixoramaendpoint': pixoramaendpoint,
        'user': user,
      };
